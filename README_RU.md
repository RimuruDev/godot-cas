...
Плагин CAS.ai SDK 4.7.4 для Godot (Android). Собирается под Godot 4.6.x.
...
| `rebuild_aar.command` | Одной командой пересобрать Godot 4 AAR (Gradle 8.7, JDK 17–21) и положить в addon проекта |
...
JDK 17–21 (Gradle 8.7 на этой машине не дружит с JDK 22/25).
